...
export class AppComponent {
  ...
  ngOnInit() { 
    $(document).ready(function () {
      "use strict";
      var e, o;
      e = $(".accordion-menu li:not(.open) ul"), o = $(".accordion-menu li.active-page > a"), e.hide(), $(".accordion-menu li a").on("click", function () {
          var e = $(this).next("ul"),
              o = $(this).parent("li"),
      ...
      }), $(".active-page > ul").length && o.click(), $("#sidebar-state").on("click", function () {
          ...
          $("body").toggleClass("small-screen-sidebar-active"), event.stopPropagation()
          ...
          $("body").toggleClass("small-screen-sidebar-active")
      }), $(".horizontal-bar-menu li:not(.open) ul").hide(), $(".horizontal-bar-menu li a").on("click", function () {
          var e = $(this).next("ul"),
              o = $(this).parent("li"),
