...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if ($(".active-page > ul").length) o.click();
    ...
    $(".small-screens-sidebar-link a").on("click", function (event) {
    ...
    if ("dark" == localStorage.getItem("theme")) $("body").addClass("dark-theme");
    if ("dark" != localStorage.getItem("theme") && $("body").hasClass("dark-theme")) localStorage.setItem("theme", "dark");
    $("#dark-theme-toggle").on("click", function (event) {
    ...
    window.addEventListener("load", function () {
      ...
      Array.prototype.filter.call(e, function (e) {
        (e as HTMLFormElement).addEventListener("submit", function (o: Event) {
          if ((e as HTMLFormElement).checkValidity() === false) {
            o.preventDefault();
            o.stopPropagation();
          }
          (e as HTMLFormElement).classList.add("was-validated");
        }, false);
      });
    }, false);
